...
export project_bdd, backproject_bdd
...
"""
function project_bdd(phantom::AbstractMatrix{<:T}, geo ; draw::Bool = false) where {T <: Number}
...
"""
function backproject_bdd(sinogram::AbstractMatrix{<:T},geo ; draw::Bool = false) where {T <: Number}
